...
# jOOQ Optimistic Locking in Spring Boot

![Java CI with Maven](https://github.com/andrei-punko/spring-boot-3-template/workflows/Java%20CI%20with%20Maven/badge.svg)
[![Coverage](.github/badges/jacoco.svg)](https://github.com/amalrajvinoth/springboot-jooq-optimistic-locking/actions/workflows/maven.yml)
[![Branches](.github/badges/branches.svg)](https://github.com/amalrajvinoth/springboot-jooq-optimistic-locking/actions/workflows/maven.yml)
